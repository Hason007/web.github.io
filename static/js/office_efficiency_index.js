...
function loadChannelBaseInfo(data){
    ...
    $("#base-info").find(".channel-name").text("");
    var popval2=keepTwoDecimal(popval);
    $("#base-info").find(".popval").text("全省前5%");
    var rePortData={};
    //厅办理业务平均耗时
...
function loadChannelHandleDetail(data){
	var option = {
		    ...
		    legend: {
		        ...
		        data: ['办卡时长', '校园服务等待时长', '消费笔数','使用人数/活跃用户量'],
		        right: '10px',top: '0px',
		    ...
		    series: [{
		        name: '办卡时长',type: 'line',smooth: true,lineStyle: {normal: {width: 2}},
		        yAxisIndex:0,
		        areaStyle: {
		            normal: {
		        ...
		        name: '校园服务等待时长',type: 'line',smooth: true,lineStyle: { normal: {width: 2}},
		        yAxisIndex:0,
		        areaStyle: {
		            normal: {
		                color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
		        ...
		        name: '消费笔数',type: 'line',smooth: true,lineStyle: {normal: {width: 2}},
		        yAxisIndex:1,
		        areaStyle: {
		            normal: {
		                color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
		        ...
		        name: '使用人数/活跃用户量',type: 'line',smooth: true,lineStyle: {normal: {width: 2}},
		        yAxisIndex:1,
		        areaStyle: {
		            normal: {
		                color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
	...
	for(var key in staffHandleInfo){
		...
		var tr1=[
			...
			'<td colspan="3">',
					...
					'<div class="avg-time-label">|&nbsp;&nbsp;年级排名&nbsp;&nbsp;&nbsp;&nbsp;</div>',
					'<div class="avg-time-value">&nbsp;&nbsp;&nbsp;&nbsp;'+itemArr[0].index+'/110</div>',
				'</td>',
			'</tr>',
			'<tr>',
				'<td> ',
					'<div class="staff-cust-time">',
					   '<span style="font-size:15px;">平均消费时长</span><br/><span style="color:#00A8FE;font-size:18px;font-weight:600;">'+itemArr[0].avgTime+'分</span>',
					'</div>',
				'</td>',
				'<td>',
					'<div class="staff-order-count">',
					    '<span style="font-size:15px;">消费笔数</span><br/><span style="color:#00A8FE;font-size:18px;font-weight:600;">'+itemArr[0].orderNum+'笔</span>',
					'</div>',
				'</td>',
				'<td>',
					'<div class="staff-alarm">',
					   '<span style="font-size:15px;">异常告警</span><br/><span style="color:#00A8FE;font-size:18px;font-weight:600;">'+wgCount+'次</span>',
					'</div>',
			    '</td>',
			'</tr> ',
...
//				'<div class="integral-label" style="width:60px;">|年级排名&nbsp;&nbsp;</div>',
		...
		if(itemArr.length>1){
			...
			tr2=[
				...
				'<tr>',
						'<td> ',
							'<div class="staff-cust-time">',
							   '<span style="font-size:15px;">平均消费时长</span><br/><span style="color:#00A8FE;font-size:18px;font-weight:600;">'+itemArr[1].avgTime+'分</span>',
							'</div>',
						'</td>',
						'<td>',
							'<div class="staff-order-count">',
							    '<span style="font-size:15px;">消费笔数</span><br/><span style="color:#00A8FE;font-size:18px;font-weight:600;">'+itemArr[1].orderNum+'笔</span>',
							'</div>',
						'</td>',
						'<td>',
							'<div class="staff-alarm">',
	...
	for(var key in deviceInfo){
		...
		var tr1=[
				'<tr> ',                                                            
					...
					'</td> ',                                                           
				    '<td><div class="label-name">'+ xitong1[idx] +'系统得分</div></td> ',
				    '<td rowspan="3" colspan="2" class="kuan-dai"> ',                   
				            '<div class="progress-label">'+ xitong1[idx] +'刷卡响应速率 '+itemArr[0].up+'</div>',
							'<div style="width:180px;height:15px;"> ',                         
								...
								'</div>',                                                    
							'</div> ',                                                      
//				            '<div class="progress-label">超市支付响应速率 '+itemArr[0].down+'</div>',
//							'<div style="width:180px;height:15px;">',
//								'<div class="progress" style="float:left;height:8px;width:180px;background-color:#383E60;">',
			...
			tr2=[
				...
				'<tr> ',                                                            
					'<td rowspan="3" class="device-img">',                            
					    '<img src="../static/images/'+gradeImg+'"/>',
					'</td> ',                                                           
					'<td><div class="label-name">'+ xitong2[idx] +'系统得分</div></td> ',
				    '<td rowspan="3" colspan="2" class="kuan-dai"> ',                   
				            '<div class="progress-label">'+ xitong2[idx] +'刷卡响应速度 '+itemArr[1].up+'</div>',
							'<div style="width:180px;height:15px;"> ',                         
								'<div class="progress" style="float:left;height:8px;width:180px;background-color:#383E60;">',
								     '<div class="progress-bar progress-bar-striped" style="min-width:0;width:'+itemArr[1].up.replace("Mbps","")+'%"></div>',
								'</div>',                                                    
							'</div> ',                                                      
//				            '<div class="progress-label">宿舍门禁刷卡响应速度 '+itemArr[1].down+'</div>',
//							'<div style="width:180px;height:15px;">',
//								'<div class="progress" style="float:left;height:8px;width:180px;background-color:#383E60;">',
...
function loadBusinessTypeTimeDetail(data){
	...
	var option = {
            ...
            xAxis: {type: 'category',axisLine: {lineStyle: {color: '#57617B'}},axisLabel: {interval:0,textStyle: {color:'#fff',size:4}},data: data.categoryArr},
            yAxis:[
       	        {
       	          type: 'value',name: '',
       	          axisLine: {lineStyle: {color: '#57617B'}},
...
function loadPageData(){
	 ...
	 if(Object.keys(groupChannelInfo).length==0){
		 ...
		 if(undefined==groupChannelInfo || null==groupChannelInfo){
			 groupChannelInfo={"channelCode":"11228790","groupChannelCode":"3201001965930","channelName":"中国大学智慧校园社保卡平台"};
	     }else{
